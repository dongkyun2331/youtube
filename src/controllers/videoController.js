...
export const edit = (req, res) => {
  return res.send(
    `<!DOCTYPE html><html lang='ko'><head><title>Youtube</title></head><body><h1>Edit video #${req.params.id}</h1><footer>&copy;2023 Youtube - All rights reserved</footer></body></html>`
  );
};
